...
// .wrangler/tmp/pages-IC0xcw/bundledWorker-0.7392340247969004.mjs
...
var Kr = /* @__PURE__ */ __name2((e, t, r) => t in e ? Vr(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, "Kr");
var _ = /* @__PURE__ */ __name2((e, t, r) => Kr(e, typeof t != "symbol" ? t + "" : t, r), "_");
var vt = /* @__PURE__ */ __name2((e, t, r) => t.has(e) || Ht("Cannot " + r), "vt");
var p = /* @__PURE__ */ __name2((e, t, r) => (vt(e, t, "read from private field"), r ? r.call(e) : t.get(e)), "p");
...
var b = /* @__PURE__ */ __name2((e, t, r, n) => (vt(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r), "b");
var x = /* @__PURE__ */ __name2((e, t, r) => (vt(e, t, "access private method"), r), "x");
var qt = /* @__PURE__ */ __name2((e, t, r, n) => ({ set _(i) {
  b(e, t, i, r);
}, get _() {
  return p(e, t, n);
} }), "qt");
var Ft = /* @__PURE__ */ __name2((e, t, r) => (n, i) => {
  let s = -1;
  return a(0);
  async function a(c) {
...
var an = /* @__PURE__ */ __name2((e) => Ct(e, decodeURI), "an");
...
var _e = /* @__PURE__ */ __name2((e, t, ...r) => (r.length && (t = _e(t, ...r)), `${(e == null ? void 0 : e[0]) === "/" ? "" : "/"}${e}${t === "/" ? "" : `${(e == null ? void 0 : e.at(-1)) === "/" ? "" : "/"}${(t == null ? void 0 : t[0]) === "/" ? t.slice(1) : t}`}`), "_e");
...
var gt = /* @__PURE__ */ __name2((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? Ct(e, gr) : e) : e, "gt");
...
var cn = vr;
var ln = /* @__PURE__ */ __name2((e, t) => vr(e, t, true), "ln");
var gr = decodeURIComponent;
var Ut = /* @__PURE__ */ __name2((e) => Ct(e, gr), "Ut");
var Re;
var B;
var Z;
var _r;
...
var yr = (or = class {
...
}, Re = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), Z = /* @__PURE__ */ new WeakSet(), _r = /* @__PURE__ */ __name2(function(e) {
  const t = p(this, B)[0][this.routeIndex][1][e], r = x(this, Z, Tt).call(this, t);
  return r && /\%/.test(r) ? Ut(r) : r;
}, "_r"), Er = /* @__PURE__ */ __name2(function() {
  ...
  return e;
}, "Er"), Tt = /* @__PURE__ */ __name2(function(e) {
...
var Ne = /* @__PURE__ */ __name2((e, t) => new Response(e, t), "Ne");
var We;
var ze;
var K;
var Se;
...
var fn = (cr = class {
  ...
  constructor(e, t) {
    ...
    _(this, "html", (e2, t2, r) => {
      const n = /* @__PURE__ */ __name2((i) => x(this, ee, Ee).call(this, i, t2, yt("text/html; charset=UTF-8", r)), "n");
...
}, We = /* @__PURE__ */ new WeakMap(), ze = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), Se = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakMap(), Ye = /* @__PURE__ */ new WeakMap(), ke = /* @__PURE__ */ new WeakMap(), Te = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakMap(), Ve = /* @__PURE__ */ new WeakMap(), Ke = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakSet(), Ee = /* @__PURE__ */ __name2(function(e, t, r) {
...
var vn = /* @__PURE__ */ __name2((e) => e.text("404 Not Found", 404), "vn");
...
var gn = (Oe = class {
  ...
  route(t, r) {
    ...
    return r.routes.map((i) => {
      var a;
      let s;
      r.errorHandler === Wt ? s = i.handler : (s = /* @__PURE__ */ __name2(async (c, o) => (await Ft([], r.errorHandler)(c, () => i.handler(c, o))).res, "s"), s[mn] = i.handler), x(a = n, L, ae).call(a, i.method, i.path, s);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, r, n) {
    let i, s;
    n && (typeof n == "function" ? s = n : (s = n.optionHandler, n.replaceRequest === false ? i = /* @__PURE__ */ __name2((o) => o, "i") : i = n.replaceRequest));
    const a = s ? (o) => {
      const u = s(o);
    ...
    const c = /* @__PURE__ */ __name2(async (o, u) => {
...
}, F = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakSet(), kr = /* @__PURE__ */ __name2(function() {
...
}, "kr"), U = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ __name2(function(t, r, n) {
...
}, te = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ new WeakMap(), ht = /* @__PURE__ */ new WeakSet(), xr = /* @__PURE__ */ __name2(function(e) {
  const t = [];
  let r = e === C;
...
}, ie = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), fe = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakSet(), oe = /* @__PURE__ */ __name2(function(t, r, n, i, s) {
...
T.get("/api/spending-breakdown", async (e) => {
  const t = /* @__PURE__ */ new Date(), r = t.toISOString().split("T")[0], n = `${t.getUTCFullYear()}-${String(t.getUTCMonth() + 1).padStart(2, "0")}-01`, i = /^\d{4}-\d{2}-\d{2}$/, s = /* @__PURE__ */ __name2((w) => i.test(w) && !isNaN(Date.parse(w)), "s"), a = (e.req.query("from") || "").trim(), c = (e.req.query("to") || "").trim();
  ...
  `).bind(o, u).all(), v = await e.env.DB.prepare(`
    ...
    GROUP BY category
    ORDER BY amount DESC
  `).bind(o, u).all(), m = /* @__PURE__ */ __name2((w) => Math.round(w * 100) / 100, "m"), g = /* @__PURE__ */ __name2((w) => f > 0 ? Math.round(w / f * 1e3) / 10 : 0, "g"), y = (h.results ?? []).map((w) => ({ vendor: w.vendor ?? "", amount: m(w.amount ?? 0), percentage: g(w.amount ?? 0) })), E = (v.results ?? []).map((w) => ({ category: w.category ?? "", amount: m(w.amount ?? 0), percentage: g(w.amount ?? 0) }));
...
var Ar = /* @__PURE__ */ __name2((e) => ({ value: t, children: r }) => {
  if (!r) return;
...
var Kt = /* @__PURE__ */ __name2((e, t, r, n) => ({ buffer: i, context: s }) => {
  if (!i) return;
  const a = Vt.get(s) || {};
  Vt.set(s, a);
  const c = a[e] || (a[e] = []);
...
var Bn = /* @__PURE__ */ __name2(({ children: e, ...t }) => ["onLoad", "onError"].some((r) => r in t) || t.rel === "stylesheet" && (!("precedence" in t) || "disabled" in t) ? Xe("link", e, t) : Ze("link", e, t, Lr(t)), "Bn");
var Hn = /* @__PURE__ */ __name2(({ children: e, ...t }) => {
  const r = Nt();
  return r && je(r) === "head" ? Xe("meta", e, t) : Ze("meta", e, t, false);
}, "Hn");
var Mr = /* @__PURE__ */ __name2((e, { children: t, ...r }) => new H(e, r, Je(t ?? [])), "Mr");
var qn = /* @__PURE__ */ __name2((e) => (typeof e.action == "function" && (e.action = ut in e.action ? e.action[ut] : void 0), Mr("form", e)), "qn");
var Nr = /* @__PURE__ */ __name2((e, t) => (typeof t.formAction == "function" && (t.formAction = ut in t.formAction ? t.formAction[ut] : void 0), Mr(e, t)), "Nr");
var Fn = /* @__PURE__ */ __name2((e) => Nr("input", e), "Fn");
var Un = /* @__PURE__ */ __name2((e) => Nr("button", e), "Un");
...
var Kn = /* @__PURE__ */ __name2(({ children: e }) => new Pr("", { children: e }, Array.isArray(e) ? e : e ? [e] : []), "Kn");
function Pe(e, t, r) {
  let n;
...
var Ce = void 0;
var Xn = /* @__PURE__ */ __name2(() => Ce, "Xn");
var V = /* @__PURE__ */ __name2((e) => "t" in e, "V");
...
var Zt = /* @__PURE__ */ __name2((e, t) => Ce && e instanceof SVGElement && /[A-Z]/.test(t) && (t in e.style || t.match(/^(?:o|pai|str|u|ve)/)) ? t.replace(/([A-Z])/g, "-$1").toLowerCase() : t, "Zt");
  ...
  for (let i in t) {
    ...
    if (i !== "children" && (!r || r[i] !== s)) {
      ...
      if (a) {
        ...
        let c;
        typeof s == "function" ? c = s(e) || (() => s(null)) : s && "current" in s && (s.current = e, c = /* @__PURE__ */ __name2(() => s.current = null, "c")), Dt.set(e, c);
      } else if (i === "style") {
        const c = e.style;
...
var At = /* @__PURE__ */ __name2((e, t, r) => {
  ...
  try {
    ...
    if (h) {
      const m = /* @__PURE__ */ __name2(() => ot([0, false, e[2]], v), "m"), g = at.get(v) || [];
      g.push(m), at.set(v, g);
      const y = h(f, () => {
        const E = at.get(v);
        if (E) {
...
var ni = /* @__PURE__ */ __name2((e, t, r) => ({ tag: Fe, props: { children: e }, key: r, e: t, p: 1 }), "ni");
var wt = 0;
var Fr = 1;
var Rt = 2;
var St = 3;
...
var Qe = /* @__PURE__ */ __name2((e, t, r, n, i) => {
  ...
  const h = dt[e], v = jr(e, n), m = /* @__PURE__ */ __name2((S) => S.getAttribute("rel") === "stylesheet" && S.getAttribute(ce) !== null, "m");
  let g;
  if (v) {
...
var vi = /* @__PURE__ */ __name2((e) => zr("input", e), "vi");
...
var _i = Mt(null);
var Ei = /* @__PURE__ */ __name2((e, t, r, n) => (i, s) => {
...
// .wrangler/tmp/pages-IC0xcw/v00n5iomy6.js
...
// .wrangler/tmp/bundle-2VgsDL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2VgsDL/middleware-loader.entry.ts
...
//# sourceMappingURL=v00n5iomy6.js.map
